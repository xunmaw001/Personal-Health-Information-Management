...
public class YishiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YishiEntity user = yishiService.selectOne(new EntityWrapper<YishiEntity>().eq("gonghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"yishi",  "管理员" );
    ...
    public R register(@RequestBody YishiEntity yishi){
    	...
    	YishiEntity user = yishiService.selectOne(new EntityWrapper<YishiEntity>().eq("gonghao", yishi.getGonghao()));
		if(user!=null) {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YishiEntity yishi, HttpServletRequest request){
