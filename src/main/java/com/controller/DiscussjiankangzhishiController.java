...
public class DiscussjiankangzhishiController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,DiscussjiankangzhishiEntity discussjiankangzhishi, HttpServletRequest request){
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,DiscussjiankangzhishiEntity discussjiankangzhishi, HttpServletRequest request){
        EntityWrapper<DiscussjiankangzhishiEntity> ew = new EntityWrapper<DiscussjiankangzhishiEntity>();
		PageUtils page = discussjiankangzhishiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, discussjiankangzhishi), params), params));
        return R.ok().put("data", page);
    }
    ...
    public R save(@RequestBody DiscussjiankangzhishiEntity discussjiankangzhishi, HttpServletRequest request){
    	discussjiankangzhishi.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<DiscussjiankangzhishiEntity> wrapper = new EntityWrapper<DiscussjiankangzhishiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = discussjiankangzhishiService.selectCount(wrapper);
