      ...
      <el-row>
        ...
        <el-form-item class="input" v-if="type!='info'"  label="摄入量" prop="sheruliang">
          <el-input v-model="ruleForm.sheruliang" 
              placeholder="摄入量" clearable  :readonly="ro.sheruliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="摄入量" prop="sheruliang">
              <el-input v-model="ruleForm.sheruliang" 
                placeholder="摄入量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.jilu" label="记录" prop="jilu">
              <el-input v-model="ruleForm.jilu" 
                placeholder="记录" readonly></el-input>
                                                                  ...
                                                                  <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="膳食" prop="shanshi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="膳食"
                  v-model="ruleForm.shanshi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shanshi" label="膳食" prop="shanshi">
                    <span>{{ruleForm.shanshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
            continue;
	            	            ...
	            	            if(o=='shanshi'){
            this.ruleForm.shanshi = obj[o];
	    this.ro.shanshi = true;
            continue;
          }
	            	            if(o=='sheruliang'){
