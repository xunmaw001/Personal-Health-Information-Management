        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.leixing"
                placeholder="类型" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="运动" prop="yundong">
          <el-input v-model="ruleForm.yundong" 
              placeholder="运动" clearable  :readonly="ro.yundong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="运动" prop="yundong">
              <el-input v-model="ruleForm.yundong" 
          ...
          <el-form-item class="input" label="时长" prop="shizhang">
              <el-input v-model="ruleForm.shizhang" 
                placeholder="时长" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="消耗" prop="xiaohao">
          <el-input v-model="ruleForm.xiaohao" 
              placeholder="消耗" clearable  :readonly="ro.xiaohao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="消耗" prop="xiaohao">
              <el-input v-model="ruleForm.xiaohao" 
                placeholder="消耗" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="记录" prop="jilu">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.jilu" 
                type="date"
                placeholder="记录">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jilu" label="记录" prop="jilu">
              <el-input v-model="ruleForm.jilu" 
                placeholder="记录" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shizhang = true;
            continue;
	            	            ...
	            	            if(o=='xiaohao'){
            this.ruleForm.xiaohao = obj[o];
	    this.ro.xiaohao = true;
            continue;
          }
	            	            if(o=='jilu'){
            this.ruleForm.jilu = obj[o];
	    this.ro.jilu = true;
            continue;
          }
	                    }
