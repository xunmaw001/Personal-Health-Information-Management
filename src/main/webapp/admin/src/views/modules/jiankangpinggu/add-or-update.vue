              ...
              <div v-else>
                <el-form-item v-if="ruleForm.zhenduanbaogao" label="诊断报告" prop="zhenduanbaogao">
                    <span>{{ruleForm.zhenduanbaogao}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="数据分析" prop="shujufenxi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="数据分析"
                  v-model="ruleForm.shujufenxi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.shujufenxi" label="数据分析" prop="shujufenxi">
                    <span>{{ruleForm.shujufenxi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
