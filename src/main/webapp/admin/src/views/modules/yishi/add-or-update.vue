          ...
          <el-form-item class="input" label="密码" prop="mima">
              <el-input v-model="ruleForm.mima" 
                placeholder="密码" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生" prop="yisheng">
          <el-input v-model="ruleForm.yisheng" 
              placeholder="医生" clearable  :readonly="ro.yisheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生" prop="yisheng">
              <el-input v-model="ruleForm.yisheng" 
                placeholder="医生" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.mima = true;
            continue;
	            	            ...
	            	            if(o=='yisheng'){
            this.ruleForm.yisheng = obj[o];
	    this.ro.yisheng = true;
            continue;
          }
	            	            if(o=='zhicheng'){
