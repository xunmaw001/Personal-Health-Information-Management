          ...
          <el-form-item class="input" label="体重" prop="tizhong">
              <el-input v-model="ruleForm.tizhong" 
                placeholder="体重" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="腰围" prop="yaowei">
          <el-input v-model="ruleForm.yaowei" 
              placeholder="腰围" clearable  :readonly="ro.yaowei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="腰围" prop="yaowei">
              <el-input v-model="ruleForm.yaowei" 
                placeholder="腰围" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="心率" prop="xinlv">
              <el-input v-model="ruleForm.xinlv" 
                placeholder="心率" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="更新" prop="gengxin">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.gengxin" 
                type="datetime"
                placeholder="更新">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.gengxin" label="更新" prop="gengxin">
              <el-input v-model="ruleForm.gengxin" 
                placeholder="更新" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xinlv = true;
            continue;
	            	            ...
	            	            if(o=='gengxin'){
            this.ruleForm.gengxin = obj[o];
	    this.ro.gengxin = true;
            continue;
          }
	                    }
                                                                                                                                                              }
