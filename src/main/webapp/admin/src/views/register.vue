  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">个人健康信息管理注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="工号" class="input" v-if="tableName=='yishi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='yishi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="text" />
			   ...
			   <div class="input-container">
			     <input v-model="ruleForm.yisheng" class="input" type="text" placeholder="医生">
			   </div>
			 </div> -->
			<el-form-item label="医生" class="input" v-if="tableName=='yishi'">
			  <el-input v-model="ruleForm.yisheng" autocomplete="off" placeholder="医生" type="text" />
			</el-form-item>
																														<!-- <div v-if="tableName=='yishi'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='yishi'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄" type="text" />
			</el-form-item>
												<!-- <div v-if="tableName=='yishi'" class="input-group">
			   <div class="label">手机</div>
  ...
  methods: {
    ...
    login() {
        ...
        return
                                                                                                            ...
                                                                                                            if((!this.ruleForm.gonghao) && `yishi` == this.tableName){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.yisheng) && `yishi` == this.tableName){
        ...
        return
                                                            ...
                                                            if((!this.ruleForm.shouji) && `yishi` == this.tableName){
        this.$message.error(`手机不能为空`);
        return
      }
        ...
        return
                                          ...
                                          if((!this.ruleForm.youxiang) && `yishi` == this.tableName){
        this.$message.error(`邮箱不能为空`);
        return
      }
        ...
        return
                                    ...
                                    if((!this.ruleForm.shenfenzheng) && `yishi` == this.tableName){
        this.$message.error(`身份证不能为空`);
        return
      }
...
<style lang="scss" scoped>
 ...
 //  }
	...
	.container {
		background-image: url("http://codegen.caihongy.cn/20210122/9fe354e599684a7b82210cf5ed7b90c0.jpg");
		height: 100vh;
