     ...
     <el-row>
        ...
        <el-form-item v-if="flag=='yonghu'" label="照片" prop="zhaopian">
          ...
          ></file-upload>
                                                ...
                                                <el-col :span="12">
        <el-form-item   v-if="flag=='yishi'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='yishi'"  label="密码" prop="mima">
          <el-input v-model="ruleForm.mima"               placeholder="密码" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item   v-if="flag=='yishi'"  label="医生" prop="yisheng">
          <el-input v-model="ruleForm.yisheng"               placeholder="医生" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        <el-form-item v-if="flag=='yishi'"  label="职称" prop="zhicheng">
          <el-select v-model="ruleForm.zhicheng" placeholder="请选择职称">
            <el-option
                v-for="(item,index) in yishizhichengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-select v-model="ruleForm.xingbie" placeholder="请选择性别">
            <el-option
                ...
                :value="item">
                        ...
                        <el-col :span="12">
        <el-form-item   v-if="flag=='yishi'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item   v-if="flag=='yishi'"  label="身份证" prop="shenfenzheng">
          <el-input v-model="ruleForm.shenfenzheng"               placeholder="身份证" clearable></el-input>
                        ...
                        <el-col :span="24">  
        <el-form-item v-if="flag=='yishi'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          :multiple="true"
          :fileUrls="ruleForm.zhaopian?ruleForm.zhaopian:''"
          @change="yishizhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
...
export default {
      ...
      if (data && data.code === 0) {
        ...
        this.$message.error(data.msg);
                                            ...
                                            this.yonghuxingbieOptions = "男,女".split(',')
                                                                                                                this.yishizhichengOptions = "医师,主治医师,副主任医师,主任医师".split(',')
  ...
  methods: {
        ...
        this.ruleForm.zhaopian = fileUrls;
                                                                                                        ...
                                                                                                        yishizhaopianUploadChange(fileUrls) {
        this.ruleForm.zhaopian = fileUrls;
    },
                                                                                            onUpdateHandler() {
       ...
       this.$message.error(`年龄应输入整数`);
        ...
        return
                                                                                                            ...
                                                                                                            if((!this.ruleForm.gonghao)&& 'yishi'==this.flag){
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.yisheng)&& 'yishi'==this.flag){
        this.$message.error('医生不能为空');
        return
      }
                                                                                                                                                                                    if( 'yishi' ==this.flag && this.ruleForm.nianling&&(!isIntNumer(this.ruleForm.nianling))){
       this.$message.error(`年龄应输入整数`);
        return
      }
                                                            if((!this.ruleForm.shouji)&& 'yishi'==this.flag){
        this.$message.error('手机不能为空');
        return
      }
        ...
        return
                                          ...
                                          if((!this.ruleForm.youxiang)&& 'yishi'==this.flag){
        this.$message.error('邮箱不能为空');
        return
      }
        ...
        return
                                    ...
                                    if((!this.ruleForm.shenfenzheng)&& 'yishi'==this.flag){
        this.$message.error('身份证不能为空');
        return
      }
